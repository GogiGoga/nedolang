...
PD_LP2	LD A,(BC)
	...
	ADD A,A
	LD E,A
	LD HL,+(SPCCOMS+0xFF20-0x2000)&65535
	ADD HL,DE
	LD E,(HL)
	INC HL
	LD D,(HL)
...
T_PACK	DB 0x06EC*2/256,(0x06EC*2)&255
	DB 0x0755-0x06EC
	DB 0x07C5-0x0755
	DB 0x083B-0x07C5
	DB 0x08B8-0x083B
